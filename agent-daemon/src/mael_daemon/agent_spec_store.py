...
One :class:`~mael_daemon.agent_model.AgentSpec` per agent, keyed by agent id. See
...
from mael_common.util import atomic_write_json, harden_path
...
class JsonAgentSpecStore:
    ...
    :func:`mael_common.util.atomic_write_json` — a crash mid-write cannot leave a
