...
:func:`~mael_common.claude_paths.sanitise_path_for_claude` rather than trying
...
from mael_common.claude_paths import get_transcript_root, sanitise_path_for_claude
