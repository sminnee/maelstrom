...
from mael_cli.integrations.uptimerobot_cli import uptimerobot_group as uptimerobot
...
class TestStatusCommand:
    ...
    @patch("mael_cli.integrations.uptimerobot_cli.format_relative_time")
    @patch(
        "mael_domain.integrations.uptimerobot.get_uptimerobot_monitors",
        return_value=["111"],
    )
...
class TestOutagesCommand:
    @patch(
        "mael_cli.integrations.uptimerobot_cli.time.time", return_value=2_000_000_000
    )
    @patch(
        "mael_domain.integrations.uptimerobot.get_uptimerobot_monitors",
        return_value=["111"],
