...
from mael_cli.agent_tui import AttachApp
...
def test_a_live_permission_request_opens_the_prompt():
    from mael_cli.agent_tui import PermissionScreen
...
def test_a_plan_review_shows_the_plan_and_approves():
    from mael_cli.agent_tui import PlanScreen
...
def test_a_wait_already_answered_in_the_backlog_does_not_prompt():
    from mael_cli.agent_tui import QuestionScreen
