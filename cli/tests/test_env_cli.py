"""Tests for mael_cli.env_cli module."""
...
class TestEnvStatus:
    ...
    @patch(
        "mael_cli.env_cli.get_app_url", return_value=("http://localhost:3000", False)
    )
    @patch("mael_cli.env_cli.load_env_state")
    @patch("mael_cli.env_cli.get_env_status")
    @patch("mael_cli.env_cli.resolve_context")
...
class TestEnvList:
    ...
    @patch("mael_cli.env_cli.get_app_url", return_value=("http://localhost:3000", True))
    @patch("mael_cli.env_cli.get_env_status")
    @patch("mael_cli.env_cli.format_uptime", return_value="5m")
    @patch("mael_cli.env_cli.list_project_envs")
    @patch("mael_cli.env_cli.resolve_context")
...
class TestEnvListAll:
    ...
    @patch("mael_cli.env_cli.get_app_url", return_value=("http://localhost:3000", True))
    @patch("mael_cli.env_cli.get_env_status")
    @patch("mael_cli.env_cli.format_uptime", return_value="2h")
    @patch("mael_cli.env_cli.list_all_envs")
...
class TestEnvStopAll:
    ...
    @patch("mael_cli.env_cli.stop_all_envs")
...
class TestEnvLogs:
    ...
    @patch("mael_cli.env_cli.get_log_files")
    @patch("mael_cli.env_cli.read_service_logs")
    @patch("mael_cli.env_cli.resolve_context")
    ...
    @patch("mael_cli.env_cli._follow_logs")
    @patch("mael_cli.env_cli.get_log_files")
    @patch("mael_cli.env_cli.read_service_logs")
    @patch("mael_cli.env_cli.resolve_context")
...
class TestEnvStatusShared:
    ...
    @patch("mael_cli.env_cli.get_shared_status")
    @patch("mael_cli.env_cli.get_app_url", return_value=None)
    @patch("mael_cli.env_cli.load_env_state")
    @patch("mael_cli.env_cli.get_env_status")
    @patch("mael_cli.env_cli.resolve_context")
    ...
    @patch("mael_cli.env_cli.get_shared_status", return_value=None)
    @patch("mael_cli.env_cli.get_app_url", return_value=None)
    @patch("mael_cli.env_cli.load_env_state")
    @patch("mael_cli.env_cli.get_env_status")
    @patch("mael_cli.env_cli.resolve_context")
