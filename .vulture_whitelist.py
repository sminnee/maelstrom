...
hasLinear  # unused variable (src/maelstrom/orchestrator/protocol.py:29)
...
prCommits  # unused variable (src/maelstrom/orchestrator/protocol.py:46)
pushedCommits  # unused variable (src/maelstrom/orchestrator/protocol.py:50)
...
executeModel  # unused variable (src/maelstrom/orchestrator/protocol.py:84)
permissionMode  # unused variable (src/maelstrom/orchestrator/protocol.py:141)
waitingOn  # unused variable (src/maelstrom/orchestrator/protocol.py:142)
lastMessage  # unused variable (src/maelstrom/orchestrator/protocol.py:143)
lastMessageAt  # unused variable (src/maelstrom/orchestrator/protocol.py:144)
lastNote  # unused variable (src/maelstrom/orchestrator/protocol.py:147)
...
exitCode  # unused variable (src/maelstrom/orchestrator/protocol.py:158)
pendingRequestIds  # unused variable (src/maelstrom/orchestrator/protocol.py:159)
agentId  # unused variable (src/maelstrom/orchestrator/protocol.py:161)
documentId  # unused variable (src/maelstrom/orchestrator/protocol.py:163)
requestId  # unused variable (src/maelstrom/orchestrator/protocol.py:164)
raisedAt  # unused variable (src/maelstrom/orchestrator/protocol.py:166)
clearedAt  # unused variable (src/maelstrom/orchestrator/protocol.py:167)
