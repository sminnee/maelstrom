...
7. **Show the result.** Tag a document worth reading whole — a guide, a README, an ADR — so the
   user reads it formatted:

   ```
   <doc-file kind="other" filename="docs/guide/planning.md" title="Planning guide">
   ```
