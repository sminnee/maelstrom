...
```
/create-subtasks <issue-id-or-description>
```

Examples:

- `/create-subtasks NORT-445`
- `/create-subtasks flexible research agent`
...
- Not in plan mode: "Create-subtasks command requires plan mode. Please enter plan mode first before
  using this command."
