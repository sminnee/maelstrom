...
orchestrator server. :func:`mael_domain.worktree.close_worktree` does the git half
...
written once here over :mod:`mael_domain.worktree_steps`. Remove differs only in
