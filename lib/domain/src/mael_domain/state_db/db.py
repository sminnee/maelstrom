...
never imports :mod:`mael_domain.state_db.migrate`. That edge would close a cycle
the moment a ladder needed anything from a higher layer. Callers want
:func:`mael_domain.state_db.migrate.open_state_db`, which supplies this build's.
"""
...
class StateDb:
    ...
    is :func:`mael_domain.state_db.migrate.open_state_db`'s job. Passing them in
    ...
    async def migrate(self) -> None:
        ...
        :class:`~mael_domain.state_db.types.PythonMigration` rung runs inside
