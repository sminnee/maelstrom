...
:class:`~mael_domain.task_table.InMemoryTaskTable` in tests.
...
class ReconcileRow:
    ...
    ``session`` is the matched live :class:`~mael_domain.session_discovery.LiveSession`,
...
async def reconcile(
    ...
    *,
    ...
    live :class:`~mael_domain.session_discovery.LiveSession` that owns it (built
