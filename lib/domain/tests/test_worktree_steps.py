...
The seam is :mod:`mael_domain.worktree_steps`: what a sequence runs, in what
...
from mael_domain import worktree as worktree_mod
from mael_domain.worktree_steps import (
    Scope,
    SequenceResult,
    Step,
    StepOutcome,
