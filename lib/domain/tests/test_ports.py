"""Tests for mael_domain.ports module."""
...
class TestAllocatePortBase:
    ...
    def test_finds_first_available(self, tmp_path, monkeypatch):
        ...
        with patch("mael_domain.ports.check_ports_free") as mock_check:
    ...
    def test_no_available_ports(self, tmp_path, monkeypatch):
        ...
        with patch("mael_domain.ports.check_ports_free", return_value=False):
...
class TestPortAllocations:
    ...
    def test_record_writes_file_at_0o600(self, tmp_path, monkeypatch):
        ...
        from mael_domain.ports import _get_allocations_path
...
class TestGetAppUrl:
    ...
    def test_with_allocation_port_in_use(self, tmp_path, monkeypatch):
        ...
        with patch("mael_domain.ports.is_port_free", return_value=False):
