...
def connected_pair(monkeypatch):
    ...
    def install(reply: dict):
        ...
        monkeypatch.setattr("mael_agent.agent_transport.open_connection", fake_open)
...
def deny_connect(monkeypatch):
    ...
    def deny(code):
        ...
        monkeypatch.setattr("mael_agent.agent_transport.open_connection", refuse)
...
def test_every_root_is_the_base_and_each_daemon_under_it(tmp_path):
    ...
    from mael_agent.agent_transport import DaemonPaths, all_roots
